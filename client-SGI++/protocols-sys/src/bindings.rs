...
extern "C" {
    pub fn client_triples_decrypt(cfhe: *const ClientFHE, c: SerialCT, shares: *mut ClientTriples);
}
extern "C" {
...
extern "C" {
    pub fn add_matrix_multiplication();
}
extern "C" {
    pub fn server_aggregation(
        cfhe: *const ClientFHE,
        a_dim: u64,
        hidden_dim: u64,
        matrix: *const *const u64,
...
extern "C" {
    pub fn client_aggregation(
        sfhe: *const ServerFHE,
        a_dim: u64,
        hidden_dim: u64,
        client_vector: *const u64,
        ct: SerialCT,
        a_matrix: *const *const u64,
    ) -> SerialCT;
}
extern "C" {
    pub fn server_free_ax(ax: *mut *mut u64, a_dim: u64);
}
