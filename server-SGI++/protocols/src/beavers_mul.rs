    ...
    P::Field: PrimeField<BigInt = <<P::Field as PrimeField>::Params as FpParameters>::BigInt>,
{
        ...
        RNG: RngCore + CryptoRng,
    {
        ...
        // Compute and send Enc(a1b1 + a1b2 + b1a2 + a2b2 - r) to client
    ...
    >(
        ...
        // ab = a1b1 + a1b2 + b1a2 + a2b2
        // Receive Enc(a1b1 + a1b2 + b1a2 + a2b2 - r) from server
        // Receive Enc(ab - r) from server
        let recv_message: OfflineMsgRcv = crate::bytes::deserialize(reader)?;
